...
describe('BulkRequest module', () => {
  describe('Common case', () => {
    ...
    describe('The methods of BulkRequest module will return BulkRequest object', () => {
    ...
    describe('Valid request', () => {
      ...
      it('[BulkRequest-1] should execute correctly all methods', () => {
        return bunkRequestResult.execute().then((resp) => {
          expect(resp).toMatchObject(expectResult);
        });
      });
    });
  });
  ...
  describe('Error Case', () => {
    describe('Invalid Request', () => {
      ...
      it('[BulkRequest-5] Error returns when there is invalid id on updateRecordById', () => {
        const addRecordData = {app: 1, record: {Number: {value: 5}}};
        const updateRecordByIdData = {app: 1, id: 99999, record: {Text: {value: 'add'}}};
        const expectBody = {
          'requests': [
            {
              'method': 'POST',
      ...
      it('[BulkRequest-14] Error returns when there is invalid assignee on updateAssigneesRecord', () => {
        const addRecordData = {app: 1, record: {Number: {value: 5}}};
        const updateRecordAssigneesData = {'app': 1, 'id': 1, 'assignees': ['user_notexist']};
        const expectBody = {
          'requests': [
            {
              'method': 'POST',
      ...
      it('[BulkRequest-15] Error returns when there is invalid record on updateAssigneesRecord', () => {
        const addRecordData = {app: 1, record: {Number: {value: 5}}};
        const updateRecordAssigneesData = {'app': 1, 'id': 99999, 'assignees': ['user_1']};
        const expectBody = {
          'requests': [
            {
              'method': 'POST',
